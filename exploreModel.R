...
poptest=generatePopulation(500,1,1) 
...
inpoint=seq(.1,.9,.1)
twiceless=sapply(inpoint,function(i)apply(replicate(20,abmSIR(poptest,1500,speed=.6,p=c(1,.5),di=2,i0=1,visu=F,inf=i)$timeseries[,2]),1,mean))
tenless=sapply(inpoint,function(i)apply(replicate(20,abmSIR(poptest,1500,speed=.6,p=c(1,.1),di=2,i0=1,visu=F,inf=i)$timeseries[,2]),1,mean))
